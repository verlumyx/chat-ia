    ...
    <>
      ...
      >
        ...
        <div className="p-3 border-t border-black/5 dark:border-white/10">
          <Link
            href="/settings"
            className="flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-medium text-foreground/80 transition-colors hover:bg-black/5 hover:text-foreground dark:hover:bg-white/5"
          >
            <svg
              width="16"
              height="16"
